...
define(["require", "exports", "lodash/isNil", "lodash/invoke", "prop-types", "react", "dayjs", "../pickers/dayPicker/DayPicker", "../pickers/monthPicker/MonthPicker", "../pickers/timePicker/HourPicker", "../pickers/timePicker/MinutePicker", "../pickers/YearPicker", "../views/InputView", "./BaseInput", "../lib", "./parse", "./shared", "../util"], function (require, exports, isNil_1, invoke_1, PropTypes, React, dayjs_1, DayPicker_1, MonthPicker_1, HourPicker_1, MinutePicker_1, YearPicker_1, InputView_1, BaseInput_1, lib_1, parse_1, shared_1, util_1) {
    "use strict";
    ...
    var DateTimeInput = /** @class */ (function (_super) {
        ...
        function DateTimeInput(props) {
            ...
            _this.handleSelectUndelayed = function (e, _a) {
                ...
                _this.setState(function (prevState) {
                    ...
                    if (mode === endAtMode) {
                        ...
                        var outValue = (0, dayjs_1.default)(date).format(_this.getDateTimeFormat());
            ...
            _this.onInputValueChange = function (e, _a) {
                var value = _a.value;
                var date = (0, util_1.createDayjsDate)(value);
                var parsedValue = (0, dayjs_1.default)(date);
        ...
        DateTimeInput.prototype.parseInternalValue = function () {
            ...
            */
            ...
            if (!(0, isNil_1.default)(year)
                ...
                return (0, util_1.createDayjsDate)({ year: year, month: month, date: date, hour: hour, minute: minute });
            }
        };
