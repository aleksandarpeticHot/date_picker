...
define(["require", "exports", "lodash/invoke", "react", "./BaseInput", "../pickers/monthPicker/MonthRangePicker", "../views/InputView", "./parse"], function (require, exports, invoke_1, React, BaseInput_1, MonthRangePicker_1, InputView_1, parse_1) {
    "use strict";
    ...
    var MonthRangeInput = /** @class */ (function (_super) {
        ...
        function MonthRangeInput(props) {
            ...
            _this.getPicker = function () {
                ...
                var _b = (0, parse_1.parseDatesRange)(value, dateFormat), start = _b.start, end = _b.end;
                return (React.createElement(MonthRangePicker_1.default, { isPickerInFocus: _this.isPickerInFocus, isTriggerInFocus: _this.isTriggerInFocus, inline: _this.props.inline, onCalendarViewMount: _this.onCalendarViewMount, closePopup: _this.closePopup, onChange: _this.handleSelect, dateFormat: dateFormat, initializeWith: (0, parse_1.buildValue)(start, initialDate, localization, dateFormat), start: start, end: end, minDate: (0, parse_1.parseValue)(minDate, dateFormat, localization), maxDate: (0, parse_1.parseValue)(maxDate, dateFormat, localization), localization: localization, onHeaderClick: function () { return undefined; } }));
            };
