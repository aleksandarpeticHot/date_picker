...
define(["require", "exports", "lodash/filter", "lodash/range", "lodash/includes", "lodash/last", "lodash/isNil", "dayjs", "react", "dayjs/plugin/isBetween", "../../views/DatesRangeView", "../BasePicker", "./DayPicker", "./sharedFunctions", "../../util"], function (require, exports, filter_1, range_1, includes_1, last_1, isNil_1, dayjs_1, React, isBetween_1, DatesRangeView_1, BasePicker_1, DayPicker_1, sharedFunctions_1, util_1) {
    "use strict";
    ...
    isBetween_1 = __importDefault(isBetween_1);
    ...
    function buildMoment(pageReferenceDate, firstOnPage, dateToBuildPosition, localization) {
        ...
        if (firstOnPage === 1 /* page starts from first day in month */) {
            var dateOptions = (0, util_1.createDayjsDate)({
                year: pageReferenceDate.year(),
                month: pageReferenceDate.month(),
                date: firstOnPage,
            });
            result = localization ? (0, dayjs_1.default)(dateOptions).locale(localization) : (0, dayjs_1.default)(dateOptions);
        }
        else {
