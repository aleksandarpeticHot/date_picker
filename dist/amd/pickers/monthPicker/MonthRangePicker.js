...
define(["require", "exports", "lodash/filter", "lodash/range", "lodash/includes", "lodash/isNil", "dayjs", "react", "../../views/MonthRangeView", "../BasePicker", "./const", "./sharedFunctions", "../../util"], function (require, exports, filter_1, range_1, includes_1, isNil_1, dayjs_1, React, MonthRangeView_1, BasePicker_1, const_1, sharedFunctions_1, util_1) {
    "use strict";
    ...
    var MonthRangePicker = /** @class */ (function (_super) {
        ...
        function MonthRangePicker(props) {
            ...
            _this.handleChange = function (e, _a) {
                ...
                var date = (0, util_1.createDayjsDate)({ year: _this.state.date.year(), month: itemPosition, date: 1 });
                if ((0, isNil_1.default)(start) && (0, isNil_1.default)(end)) {
                    data.value =
                        localization
                            ? { start: (0, dayjs_1.default)(date).locale(localization) }
                            : { start: (0, dayjs_1.default)(date) };
                }
                    ...
                    data.value =
                        localization
                            ? {
                                start: start,
                                end: (0, dayjs_1.default)(date).locale(localization).endOf('month'),
                            }
                            : {
                                start: start,
                                end: (0, dayjs_1.default)(date).endOf('month'),
                            };
                }
