...
var DateInput = /** @class */ (function (_super) {
    ...
    function DateInput(props) {
        ...
        _this.handleSelect = function (e, _a) {
            ...
            _this.setState(function (prevState) {
                ...
                if (mode === 'day') {
                    ...
                    var outValue = dayjs(date).format(_this.props.dateFormat);
        ...
        _this.onInputValueChange = function (e, _a) {
            var value = _a.value;
            var parsedValue = dayjs(value, _this.props.dateFormat);
    ...
    DateInput.prototype.parseInternalValue = function () {
        ...
        */
        ...
        if (!isNil(year) || !isNil(month) || !isNil(date)) {
            var currentYear = year !== null && year !== void 0 ? year : dayjs().year();
     ...
     */
    DateInput.defaultProps = __assign(__assign({}, BaseInput.defaultProps), { dateFormat: 'DD-MM-YYYY', startMode: 'day', preserveViewMode: true, icon: 'calendar' });
    DateInput.propTypes = __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, BaseInputPropTypes), DateRelatedPropTypes), MultimodePropTypes), DisableValuesPropTypes), EnableValuesPropTypes), MarkedValuesPropTypes), MinMaxValuePropTypes), {
