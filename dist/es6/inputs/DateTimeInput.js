...
var DateTimeInput = /** @class */ (function (_super) {
    ...
    function DateTimeInput(props) {
        ...
        _this.handleSelectUndelayed = function (e, _a) {
            ...
            _this.setState(function (prevState) {
                ...
                if (mode === endAtMode) {
                    var date = createDayjsDate(value);
                    var outValue = dayjs(date).format(_this.getDateTimeFormat());
                    invoke(_this.props, 'onChange', e, __assign(__assign({}, _this.props), { value: outValue }));
                }
                return {
                    year: value.year,
                    month: value.month,
        ...
        _this.onInputValueChange = function (e, _a) {
            ...
            invoke(_this.props, 'onChange', e, __assign(__assign({}, _this.props), { value: value }));
        };
    ...
    DateTimeInput.prototype.parseInternalValue = function () {
        ...
        */
        ...
        if (!isNil(year)
            ...
            || !isNil(hour)
            || !isNil(minute)) {
            return createDayjsDate({ year: year, month: month, date: date, hour: hour, minute: minute });
        }
    };
    DateTimeInput.prototype.getDateTimeFormat = function () {
        ...
        return dateTimeFormat || "".concat(dateFormat).concat(divider).concat(TIME_FORMAT[timeFormat]);
    };
     ...
     */
    DateTimeInput.defaultProps = __assign(__assign({}, BaseInput.defaultProps), { dateFormat: 'DD-MM-YYYY', timeFormat: '24', startMode: 'day', divider: ' ', icon: 'calendar', preserveViewMode: true, disableMinute: false });
    DateTimeInput.propTypes = __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, BaseInputPropTypes), DateRelatedPropTypes), TimeRelatedPropTypes), MultimodePropTypes), DisableValuesPropTypes), MarkedValuesPropTypes), MinMaxValuePropTypes), {
