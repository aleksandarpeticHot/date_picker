...
var Cell = /** @class */ (function (_super) {
    ...
    function Cell() {
        ...
        _this.onCellClick = function (event) {
            ...
            invoke(_this.props, 'onClick', event, __assign(__assign({}, _this.props), { itemPosition: itemPosition, value: content }));
        };
        _this.onCellHover = function (event) {
            var itemPosition = _this.props.itemPosition;
            invoke(_this.props, 'onHover', event, __assign(__assign({}, _this.props), { itemPosition: itemPosition }));
        };
        return _this;
    }
