...
var InputView = /** @class */ (function (_super) {
    ...
    function InputView() {
        ...
        _this.onBlur = function (e) {
            ...
            if (e.relatedTarget !== _this.popupNode
                ...
                && !checkIE()) {
                invoke.apply(void 0, __spreadArray([_this.props, 'onBlur', e], args, false));
                closePopup();
            }
        };
        _this.onMouseLeave = function (e) {
            ...
            if (e.relatedTarget !== _this.popupNode && e.relatedTarget !== _this.inputNode) {
                if (closeOnMouseLeave) {
                    invoke.apply(void 0, __spreadArray([_this.props, 'onMouseLeave', e], args, false));
        ...
        _this.onMouseEnter = function (e) {
            ...
            invoke.apply(void 0, __spreadArray([_this.props, 'onMouseEnter', e], args, false));
    ...
    InputView.prototype.render = function () {
        ...
        var inputElement = (React.createElement(FormInputWithRef, __assign({}, rest, { 
            ...
            readOnly: (checkMobile() && hideMobileKeyboard) || readOnly, icon: icon, iconPosition: icon && iconPosition !== 'right' ? iconPosition : undefined, innerRef: function (e) { _this.inputNode = e; onMount(e); }, value: value, tabIndex: tabIndex, inline: inlineLabel, onClear: function (e) { return (onClear || onChange)(e, __assign(__assign({}, rest), { value: '' })); }, onFocus: function (e) {
